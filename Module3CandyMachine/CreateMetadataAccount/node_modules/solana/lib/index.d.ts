...
declare type ClientSubscriptionId = number;
...
declare type BlockhashWithExpiryBlockHeight = Readonly<{
  blockhash: Blockhash;
 ...
 */
declare type BlockheightBasedTransactionConfirmationStrategy = {
 ...
 */
declare type GetAccountInfoConfig = {
 ...
 */
declare type GetStakeMinimumDelegationConfig = {
  /** The level of commitment desired */
  commitment?: Commitment;
};
/**
 ...
 */
declare type GetBlockHeightConfig = {
  /** The level of commitment desired */
  commitment?: Commitment;
  /** The minimum slot that the request can be evaluated at */
  minContextSlot?: number;
 ...
 */
declare type GetEpochInfoConfig = {
  /** The level of commitment desired */
  commitment?: Commitment;
  /** The minimum slot that the request can be evaluated at */
  minContextSlot?: number;
 ...
 */
declare type GetInflationRewardConfig = {
  /** The level of commitment desired */
  commitment?: Commitment;
 ...
 */
declare type GetLatestBlockhashConfig = {
  /** The level of commitment desired */
  commitment?: Commitment;
  /** The minimum slot that the request can be evaluated at */
  minContextSlot?: number;
 ...
 */
declare type GetSlotLeaderConfig = {
  /** The level of commitment desired */
  commitment?: Commitment;
  /** The minimum slot that the request can be evaluated at */
  minContextSlot?: number;
 ...
 */
declare type GetTransactionConfig = {
  /** The level of finality desired */
  commitment?: Finality;
  /** The max transaction version to return in responses. If the requested transaction is a higher version, an error will be returned */
  maxSupportedTransactionVersion?: number;
...
declare type TransactionReturnDataEncoding = 'base64';
declare type TransactionReturnData = {
  programId: string;
 ...
 */
declare type GetStakeActivationConfig = {
  /** Optional commitment level */
  commitment?: Commitment;
 ...
 * Configuration object for `getStakeActivation`
 */
declare type GetTokenAccountsByOwnerConfig = {
  /** Optional commitment level */
  commitment?: Commitment;
  /** The minimum slot that the request can be evaluated at */
  minContextSlot?: number;
 ...
 * Configuration object for `getStakeActivation`
 */
declare type GetTransactionCountConfig = {
  /** Optional commitment level */
  commitment?: Commitment;
  /** The minimum slot that the request can be evaluated at */
  minContextSlot?: number;
 ...
 */
declare type FetchFn = typeof export_default;
/**
 ...
 */
declare type TransactionCtorFields_DEPRECATED = {
...
declare type TransactionCtorFields = TransactionCtorFields_DEPRECATED;
/**
 * List of Transaction object fields that may be initialized at construction
 */
declare type TransactionBlockhashCtor = {
  /** The transaction fee payer */
  feePayer?: PublicKey | null;
  /** One or more signatures */
  signatures?: Array<SignaturePubkeyPair>;
...
declare type CreateLookupTableParams = {
...
declare type FreezeLookupTableParams = {
  /** Address lookup table account to freeze. */
  lookupTable: PublicKey;
  /** Account which is the current authority. */
  authority: PublicKey;
};
declare type ExtendLookupTableParams = {
...
declare type DeactivateLookupTableParams = {
  /** Address lookup table account to deactivate. */
  lookupTable: PublicKey;
  /** Account which is the current authority. */
  authority: PublicKey;
};
declare type CloseLookupTableParams = {
 ...
 */
declare type LookupTableInstructionType =
  | 'CreateLookupTable'
  | 'ExtendLookupTable'
  | 'CloseLookupTable'
  | 'FreezeLookupTable'
 ...
 */
declare type ComputeBudgetInstructionType =
  | 'RequestUnits'
  | 'RequestHeapFrame'
  | 'SetComputeUnitLimit'
  | 'SetComputeUnitPrice';
...
declare type DecodedTransferInstruction = {
  /** Account that will transfer lamports */
  fromPubkey: PublicKey;
  /** Account that will receive transferred lamports */
  toPubkey: PublicKey;
...
declare type DecodedTransferWithSeedInstruction = {
  /** Account that will transfer lamports */
  fromPubkey: PublicKey;
  /** Base public key to use to derive the funding account address */
  basePubkey: PublicKey;
...
declare type SolanaJSONRPCErrorCodeEnum =
